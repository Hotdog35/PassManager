...
<form class="form-control">
	<input class="input-group-btn" type="submit" name="EXPR">
</form>
		...
		<nav class="col-md-2 d-md-block bg-light sidebar">
			<div class="sidebar-sticky">
				<ul class="nav flex-column">
					...
					<?php  if($_SESSION["meu_ip"] == '10.2.1.32' || $_SESSION["meu_ip"] == '10.2.1.33') {	 ?>
					<li class="nav-item">
...
<div class="conaitner-fluid">
	<div class="row">
		...
		<div class="col">
			<h3>Cadastro de Senhas<span><a class="btn btn-success" data-toggle="modal" data-target="#register">+</a></span></h3>
		</div>
	</div>
</div>
...
<div class="table-responsive">
    <table class="table table-striped table-sm">
        <thead>
            <tr>
              <th><span class="fa fa-unlock-alt"></span>
              </th>
              <th>Link</th>
              <th>Login</th>
              <th>Senha</th>
        ...
        <tbody class="table-inverse">
        	<tr id="areaRegister" class="collapse">
        		<td class="text-danger font-weight-bold" id="alterId"></td>
              	...
              	<td id="passArea"></td>
              	<td id="goalArea"></td>
              	<td id=""><a onclick="usuario.saveEntry(1)" class="btn btn-success btn-sm" href="#">Salvar</a><td>
          	...
          	<tr id="alterRegister" class="collapse">
        		<td class="text-danger font-weight-bold">!</td>
              	...
              	<td id=""><a onclick="usuario.alterEntry(1)" class="btn btn-success btn-sm" href="#">Alterar</a><td>
              	<td id=""><a onclick="usuario.cancelEntry()" class="btn btn-danger btn-sm" href="#">Cancelar</a><td>
          	</tr>
<?php require_once("php/actions/requestpass.php");?>
        </tbody>
    </table>
    	<div class='col-md-12'>
			<ul class='pagination'>
							...
							<div class="col-12">
								<form class="form-modal" method="post">
									...
									<div class="modal-footer">
										<a onclick="usuario.putValues()"  class="btn">Cadastrar</a>
									</div>
								</form>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-12">
								<form class="form-modal" method="post">
									<div class="form-row">
										<div class="col-md-6 form-group">
											<label for="alterLink" class="col-form-label">Link:</label>
											<input type="text" class="form-control" id="alterLink"  placeholder="Digite o endereço do Site" required>
										</div>
										<div class="col-md-6 form-group">
											<label for="alterLog" class="col-form-label">Login:</label>
											<input type="text" class="form-control" id="alterLog" placeholder="Digite seu Login do site" required>
										</div>
									</div>
									<div class="form-row">
										<div class="col-md-6 form-group">
											<label for="alterGoal" class="col-form-label">Finalidade:</label>
											<input type="text" name="goalValue" placeholder="Ex:gmglobalconnect" class="form-control" id="alterGoal" required>
										</div>
										<div class="col-md-6 form-group">
											<label for="alterPass" class="col-form-label">Senha:</label>
											<input type="text" class="form-control" id="alterPass"  placeholder="Digite sua Senha" required>
										</div>
									</div>	
									<div class="modal-footer">
										<a onclick="usuario.alterPutValues()"  class="btn">Alterar</a>
									</div>
								</form>
							</div>
						</div>
